...
<section class="products-section" style="{{ $shopBanner ? 'padding: 60px 0;' : 'padding-top: 140px;' }} min-height: 80vh;">
  <div class="section-inner">
    ...
    <div class="filter-bar reveal visible" style="margin-bottom: 40px; justify-content: center; display: flex; gap: 10px; flex-wrap: wrap;">
      <a href="{{ route('shop.index') }}" class="filter-btn active" style="text-decoration:none">All</a>
      @foreach($categories as $cat)
        <a href="{{ route('shop.category', $cat['slug']) }}" class="filter-btn" style="text-decoration:none">
          {{ $cat['name'] }}
        </a>
      @endforeach
    </div>
